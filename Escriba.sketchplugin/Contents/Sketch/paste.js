...
exports.pasteSelected = pasteSelected;
...
exports['default'] = function (context) {
	...
	if (selectedOverrides.length > 0) {
		selectedOverrides.forEach(function (selectedOverride) {
			...
			(0, _analytics2['default'])(context, "Escriba Initiated", "Paste selected", selectedOverrideId);
...
function pasteSelected(selectedOverrideId, context) {
	selection.forEach(function (layer) {
		layer.overrides.forEach(function (override) {
			if (selectedOverrideId == override.affectedLayer.id) {
				...
				var getseetting = ['Value' + String(property)];
				...
				if (settingValue == 1 || undefined) {
					...
					(0, _analytics2['default'])(context, "Escriba Success", "Paste done", setting);
				} else {
